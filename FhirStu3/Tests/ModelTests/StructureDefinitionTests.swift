...
class StructureDefinitionTests: XCTestCase {
	...
	func testStructureDefinition1() {
        do {
            let data = try bundle.loadJSONData(named: "structuredefinition-example.json")
            let instance = try decoder.decode(StructureDefinition.self, from: data)
            try runEncodableAndEqualityChecks(instance)
			runStructureDefinition1(instance)
        } catch {
            XCTFail(error.localizedDescription)
        }
	}

	func runStructureDefinition1(_ inst: StructureDefinition) {
		XCTAssertEqual(inst.abstract, false)
		XCTAssertEqual(inst.baseDefinition, "http://hl7.org/fhir/StructureDefinition/DiagnosticReport")
		...
		XCTAssertEqual(inst.keyword?[0].system, "http://snomed.info/sct")
		...
		XCTAssertEqual(inst.snapshot?.element?[6].type?[0].targetProfile, "http://hl7.org/fhir/StructureDefinition/Patient")
		...
		XCTAssertEqual(inst.snapshot?.element?[6].type?[1].targetProfile, "http://hl7.org/fhir/StructureDefinition/Group")
		...
		XCTAssertEqual(inst.snapshot?.element?[6].type?[2].targetProfile, "http://hl7.org/fhir/StructureDefinition/Device")
		...
		XCTAssertEqual(inst.snapshot?.element?[7].type?[0].targetProfile, "http://hl7.org/fhir/StructureDefinition/Organization")
		...
		XCTAssertEqual(inst.snapshot?.element?[9].type?[0].targetProfile, "http://hl7.org/fhir/StructureDefinition/ProcedureRequest")
		...
		XCTAssertEqual(inst.useContext?[0].code?.system, "http://hl7.org/fhir/usage-context-type")
		...
		XCTAssertEqual(inst.useContext?[0].valueCodeableConcept?.coding?[0].system, "http://snomed.info/sct")
