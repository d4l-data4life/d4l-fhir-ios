...
tpl_resource_target = '../generated'                # target directory to write the generated class files to
...
#tpl_factory_target = '../generated/FHIRAbstractBase+Factory.swift'    # where to write the generated factory to
...
tpl_unittest_target = '../generated_tests'        # target directory to write the generated unit test files to
...
#     '../parser-resources/XCTestCase+FHIR.swift',
#     '../parser-resources/DateAndTimeTests.swift',
# ]
...
manual_profiles = [
    ('../parser-resources/FHIRAbstractBase.swift', None, ['FHIRAbstractBase']),
    ('../parser-resources/FHIRAbstractResource.swift', None, ['FHIRAbstractResource']),
    ('../parser-resources/FHIRPrimitive.swift', None, []),
    ('../parser-resources/FHIRString.swift', None, [
        'string', 'code', 'id', 'uuid', 'markdown', 'xhtml',
    ]),
    ('../parser-resources/FHIRURL.swift', None, [
        'uri', 'oid'
    ]),
    ('../parser-resources/DateAndTime.swift', None, [
        'date', 'dateTime', 'time', 'instant',
    ]),
    ('../parser-resources/Base64Binary.swift', None, [
        'base64Binary',
    ]),
    ('../parser-resources/FHIRBool.swift', None, [
        'boolean',
    ]),
    ('../parser-resources/FHIRDecimal.swift', None, [
        'decimal',
    ]),
    ('../parser-resources/FHIRInteger.swift', None, [
