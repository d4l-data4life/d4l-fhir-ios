...
<div align="center">
    ...
    <p><!-- PROJECT ISSUES/FEATURES -->
        <a href="https://github.com/d4l-data4life/d4l-fhir-ios/issues">Report Bug</a>
        ·
        <a href="https://github.com/d4l-data4life/d4l-fhir-ios/issues">Request Feature</a>
    </p>
    <p><!-- PROJECT BADGES see badges.adoc how to change them -->
        <a href="https://github.com/d4l-data4life/d4l-fhir-ios/releases">
...
[Apple-FHIR](https://github.com/apple/FHIRModels) R4 models were (tepmorarily) ported over.
